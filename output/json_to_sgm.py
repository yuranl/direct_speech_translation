...
setid = "connected" #id used to identify this set of data

#input_path = "./eval/data/source/"
#input_path = "./eval/data/baseline_model_output/"
input_path = "./eval/data/ASR_MT_model_output/"
